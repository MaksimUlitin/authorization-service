...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = userCollection.FindOne(ctx, gin.H{"user_id": foundUser.User_id}).Decode(&foundUser)
		if err != nil {
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		page, errOne := strconv.Atoi(c.Query("page"))
		if errOne != nil || page < 1 {
			page = 1
		}
